...
This codebook describes the variables, data, and data transformations used to produce a tidy dataset from the Human Activity Recognition Using Smartphones Dataset (UCI HAR Dataset).
The data source
